registrationModule.controller('saldos_controller', function($scope, $modalInstance, $modal, saldos, userFactory, nombreCentroTrabajo, callback, error, $http, $sce, $window) {
    $scope.presupuesto = 0;
    $scope.utilizado = 0;
    $scope.saldo = 0;
    $scope.venta = 0;
