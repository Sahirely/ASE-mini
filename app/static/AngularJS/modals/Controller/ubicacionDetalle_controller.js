...
registrationModule.controller('ubicacionDetalle_controller', function ($scope, $modalInstance,  $modal, idUnidad, callback, error, $http, $sce, $window, sustitutoRepository, MarkerCreatorService, alertFactory) {
