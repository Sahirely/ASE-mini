...
var registrationModule = angular.module("registrationModule", ["ngRoute", "LocalStorageModule", "angular.filter", "dndLists",
    ...
    .config(function ($routeProvider, $locationProvider, $sceDelegateProvider) {
        ...
        $routeProvider.when('/reporteestatusorden', {
            templateUrl: 'AngularJS/Reporte/Templates/reporteEstatusOrden.html',
            controller: 'reporteEstatusOrdenController'
        });
        ...
        $routeProvider.when('/evidenciaSustituto', {
