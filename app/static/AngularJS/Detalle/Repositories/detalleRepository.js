...
registrationModule.factory('detalleRepository', function($http) {
    return {
        ...
        getFacturas: function(numeroOrden, estatus, idUsuario, idContratoOperacion, pathSend) {
            return $http({
        ...
        updateDetalleCotizacion: function(idCotizacionDetalle, costo, venta, idUsuario, cantidad)
        {
            return $http({
