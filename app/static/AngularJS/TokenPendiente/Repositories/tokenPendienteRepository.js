...
registrationModule.factory('tokenPendienteRepository', function ($http) {
    return {
        ...
        getObtenerOrdenesToken: function(idContratoOperacion, numeroOrden, idEjecutivo, idUsuario) {
            var data = {
                idContratoOperacion: idContratoOperacion,
            ...
            return $http({
                url: reporteDummyUrl + 'ObtenerOrdenesToken',
                method: "GET",
                params: data,
                headers: {
                    'Content-Type': 'application/json'
