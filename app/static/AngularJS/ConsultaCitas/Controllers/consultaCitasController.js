registrationModule.controller('consultaCitasController', function($scope, $route, $modal, $rootScope, localStorageService, alertFactory, globalFactory, consultaCitasRepository, ordenServicioRepository, cotizacionRepository, trabajoRepository, uploadRepository) {
    ...
    var getUnidad = function(datoUnidad) {
        ...
        $scope.promise = consultaCitasRepository.getUnidadInformation(datoUnidad, $scope.userData.idUsuario).then(function(unidadInfo) {
    ...
    var getCita = function(idUnidad, idUsuario) {
        ...
        $scope.promise = consultaCitasRepository.getCita(idUnidad, idUsuario).then(function(cita) {
    ...
    var getCitaTaller = function(fecha, idCita, idUsuario) {
        ...
        $scope.promise = consultaCitasRepository.getCitaTaller(fecha, idCita, idUsuario).then(function(cita) {
            if (cita.data.length > 0) {
    ...
    $scope.lookUpTaller = function(datoTaller) {
        if (datoTaller !== '' && datoTaller !== undefined) {
            ...
            $scope.promise = consultaCitasRepository.getTaller(datoTaller, $scope.userData.idUsuario).then(function(taller) {
            ...
            if (($scope.procesAutotanque == "1" && $scope.requiereGrua == undefined) || ($scope.procesAutotanque == "1" && $scope.clasificacionCita == "")) {
                ...
                if ($scope.userData.idTipoUsuario != 4 && $scope.datosCita.idTaller == undefined) {
                    ...
                    if ($scope.unidadInfo.idZona == 2 && $scope.altace == undefined) {
                        ...
                        consultaCitasRepository.addCita(citaTaller).then(function(cita) {
                            ...
                            if (citaTaller.idCita > 0) {
                                ...
                                if ($scope.datosCita.pieza != "") {
                                    $scope.datosCita.pieza.forEach(function(pieza, i) {
                                        ...
                                        consultaCitasRepository.addCitaServicioDetalle(item).then(function(piezaInserted) {
                                            if (piezaInserted.data.length > 0) {
                                                alertFactory.success("Se insertó correctamente");
                                            }
                                            if (($scope.datosCita.pieza.length - i) == 1) {
                                                consultaCitasRepository.enviarMailConfirmacion(citaTaller.idCita, $scope.userData.idTipoUsuario).then(function(enviado) {
    ...
    $scope.goToCotizacionTrabajo = function(cita) {
        ...
        $scope.promise = consultaCitasRepository.getTrabajo(cita.idCita).then(function(trabajo) {
    ...
    var getCliente = function() {
        consultaCitasRepository.getCliente($scope.userData.idUsuario).then(function(cliente) {
    ...
    var getTipoCita = function() {
        consultaCitasRepository.getTipoCita().then(function(citas) {
        ...
        if (($scope.datosCita.fechaCita != undefined && $scope.datosCita.fechaCita != "") && ($scope.datosCita.horaCita != undefined && $scope.datosCita.horaCita != "") &&
            ...
            if (($scope.procesAutotanque == "1" && $scope.requiereGrua == undefined) || ($scope.procesAutotanque == "1" && $scope.clasificacionCita == "")) {
                ...
                if ($scope.userData.idTipoUsuario != 4 && $scope.datosCita.idTaller == undefined) {
                    ...
                    citaTaller.idTrasladoUnidad = $scope.requiereGrua;
                    citaTaller.idEstadoAutotanque = $scope.idEstadoAutotanque;
                    consultaCitasRepository.updateCita(citaTaller).then(function(cita) {
                        ...
                        if (citaTaller.idCita > 0) {
                            ...
                            if ($scope.datosCita.pieza != "") {
                                $scope.datosCita.pieza.forEach(function(pieza, i) {
                                    ...
                                    consultaCitasRepository.addCitaDetalle(item).then(function(piezaInserted) {
                                        if (piezaInserted.data.length > 0) {
                                            alertFactory.success("Se insertó correctamente");
                                        }
                                        if (($scope.datosCita.pieza.length - i) == 1) {
    ...
    var getidCita = function(idCita) {
        consultaCitasRepository.getidCita(idCita).then(function(result) {
    ...
    $scope.dropCita = function(idCita) {
        consultaCitasRepository.dropCita(idCita).then(function(result) {
    ...
    var busquedaServicioDetalle = function(idCita) {
        consultaCitasRepository.busquedaServicioDetalle(idCita)
    ...
    var getEstadoAutotanque = function() {
        consultaCitasRepository.getEstadoAutotanque().then(function(result) {
            if (result.data.length > 0) {
    ...
    var getTrasladoUnidad = function() {
        consultaCitasRepository.getTrasladoUnidad().then(function(result) {
            if (result.data.length > 0) {
    ...
    $scope.getPreCotizacion = function(idCita) {
        consultaCitasRepository.getPreOrden(idCita).then(function(preCotizaciones) {
    ...
    $scope.deletePreCotizacion = function(idCita, idCotizacion) {
        consultaCitasRepository.eliminaPreCotizacion(idCita, idCotizacion).then(function(result) {
            if (result.data.length > 0) {
    ...
    $scope.aprobacionCita = function() {
        consultaCitasRepository.enviaAprobacion($scope.cita.idCita).then(function(result) {
