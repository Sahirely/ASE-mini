...
Detalle.prototype.get_validaFactura = function(req, res, next){
    ...
    switch( parseInt(req.query.caso) ){
        case 1: var xml_b64 = new Buffer( xml1 ).toString('base64'); break;
        case 2: var xml_b64 = new Buffer( xml2 ).toString('base64'); break;
        case 3: var xml_b64 = new Buffer( xml3 ).toString('base64'); break;
        case 4: var xml_b64 = new Buffer( xml4 ).toString('base64'); break;
    }
